...
(function() {
  var Cache, DeferredObject, Fact_deferred_Model, Model, async,
  ...
  module.exports = Fact_deferred_Model = (function(_super) {
    ...
    Fact_deferred_Model.prototype.load = function(query, withFK, callback) {
      var args, self;
      args = Array.prototype.slice.call(arguments, 1);
      callback = args.pop();
      withFK = args.pop() || false;
      self = this;
      return Fact_deferred_Model.__super__.load.call(this, query, function(err, row, query) {
        var _this = this;
        this.data = new DeferredObject(this.data);
        return this.getSettings(function(err, settings) {
          var key, props, _fn, _ref;
          _ref = settings.foreign_keys || {};
          _fn = function(key, props) {
            return _this.data.defer(key, function(data, next) {
    ...
    Fact_deferred_Model.prototype.loadAll = function(query, withFK, callback) {
      var args,
        _this = this;
      args = Array.prototype.slice.call(arguments, 1);
      callback = args.pop();
      ...
      return this.table.find(query, {
        ...
        return async.map(ids, loader, function() {
          return callback.apply(this, arguments);
        });
      });
    };

    Fact_deferred_Model.prototype.loadFK = function(chain, callback) {
      var args, self;
      ...
      return this.getSettings(function(err, settings) {
        ...
        loadFK = function(arr, next) {
          ...
          return Fact_deferred_Model.parseObject(fk.query, {
            fact: self.data
          }, function(query) {
            return new Fact_deferred_Model(self.account, fk.fact_type, function() {
