...
(function() {
  ...
  module.exports = Fact_deferred_Model = (function(_super) {
    ...
    Fact_deferred_Model.prototype.markUpdated = function(id, callback) {
      var args, job, _ref;
      args = Array.prototype.slice.call(arguments);
      callback = args.pop();
      id = (_ref = args.pop()) != null ? _ref : this.data._id;
      if (id) {
        job = jobs.create('fact_update', {
          title: "" + this.type + " - " + this.data._id,
          account: this.account.data._id,
          data: {
            fact_id: this.data._id,
            fact_type: this.type,
            version: null
          }
        });
    ...
    Fact_deferred_Model.prototype.markUpdatedFull = function(callback) {
      ...
      return this.table.aggregate({
        ...
        insert = function(id, next) {
          return _this.markUpdated(id, next);
        };
