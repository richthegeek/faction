...
(function() {
  ...
  */
  ...
  Fact_deferred_Model.parseObject = function(obj, context, callback) {
    ...
    console.log('pre iter', obj != null, context != null, callback != null);
    if (!((obj != null) && (context != null) && (callback != null))) {
      console.log('fail1');
      process.exit(0);
    }
    iter = function(node, next) {
      console.log('in iter', (node != null ? node.value : void 0) != null, context != null, next != null);
      if (!((node != null) && (next != null))) {
        console.log('fail2');
        process.exit(0);
      }
      if (Fact_deferred_Model == null) {
