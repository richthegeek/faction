...
(function() {
  ...
  module.exports = Model = (function() {
    ...
    Model.prototype.loadPaginated = function(conditions, req, callback) {
      var skip, _ref, _ref1, _ref2, _ref3,
        _this = this;
      req.query.page = Number((_ref = (_ref1 = req.query.page) != null ? _ref1 : req.body.page) != null ? _ref : 0);
      req.query.limit = Number((_ref2 = (_ref3 = req.query.limit) != null ? _ref3 : req.body.limit) != null ? _ref2 : 100);
      ...
      return this.table.find(conditions, function(err, cursor) {
        ...
        return cursor.count(function(err, size) {
          var bits, key, param, sort, val, _i, _len, _ref4;
          sort = false;
          if (req.params.sort) {
