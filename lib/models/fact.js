...
(function() {
  ...
  module.exports = Fact_Model = (function(_super) {
    ...
    Fact_Model.prototype.addShim = function(callback) {
      var FKCache, cache, loadFK, table, type, _settings,
        _this = this;
      table = this.table;
      type = this.type;
      FKCache = {};
      ...
      return _settings.get(function(err, allSettings) {
        var fk_arr, k, loadAutoFKs, set, settings, v, _base, _ref;
        settings = ((function() {
          var _i, _len, _results;
          _results = [];
        ...
        loadAutoFKs = function(fk, next) {
          ...
          return loadFK(fk, function(err, data) {
            if (data) {
              _this.data[fk.key] = data;
            }
            return next();
          });
        };
