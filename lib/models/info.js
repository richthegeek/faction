  ...
  Info_Model.prototype.setup = function() {
    ...
    return this.table.addStreamOperationType('info_multiplex', {
      ...
      exec: function(row, callback) {
        var interpolate, modes, time,
          _this = this;
        if (!this.handler_cache) {
          this.handler_cache = new this.modules['shared-cache']('info-handlers', true, function(key, next) {
        ...
        return this.handler_cache.get(function(err, handlers, cache_hit) {
          var iterator;
