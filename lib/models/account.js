...
module.exports = Account_Model = (function(_super) {
  ...
  function Account_Model(callback) {
    Account_Model.__super__.constructor.call(this, 'core', 'accounts', callback);
  }
  ...
  Account_Model.prototype.setup = function() {
    new Action_Model(this, function() {
      return this.setup();
    });
    new Condition_Model(this, function() {
      return this.setup();
    });
    new Infohandler_Model(this, function() {
      return this.setup();
    });
    return new Info_Model(this, function() {
      return this.setup();
    });
  };
  ...
  Account_Model.prototype.generateKey = function(name, parent, endpoints, callback) {
    var reg, regex, _base, _i, _len,
      _this = this;
    if (endpoints == null) {
      endpoints = [];
    }
