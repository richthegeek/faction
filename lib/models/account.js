...
module.exports = Account_Model = (function(_super) {
  ...
  Account_Model.prototype.setup = function() {
    ...
    new Actionresult_Model(this, function() {
      return this.setup();
    });
    new Condition_Model(this, function() {
      return this.setup();
    });
    new Fact_Model(this, 'setup', function() {
      return this.setup();
    });
    new Factsettings_Model(this, function() {
      return this.setup();
    });
    new Hook_Model(this, function() {
      return this.setup();
    });
    new Info_Model(this, function() {
      return this.setup();
    });
    return new Infomapping_Model(this, function() {
      return this.setup();
    });
  };
