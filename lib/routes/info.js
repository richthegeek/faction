...
module.exports = function(server) {
  ...
  server.post('/info/:info-type/handlers/:handler-id', Infohandler_Model.route, function(req, res, next) {
    var _this = this;
    delete req.body._id;
  ...
  return server.del('/info/:info-type/handlers/:handler-id', Infohandler_Model.route, function(req, res, next) {
