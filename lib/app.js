...
(function() {
  ...
  server.use(function(rq, rs, n) {
    return n(null, rq.logTime('pre-QueryParser'));
  });

  server.use(restify.queryParser());

  server.use(function(rq, rs, n) {
    return n(null, rq.logTime('post-QueryParser'));
  });
  ...
  server.use(function(rq, rs, n) {
    return n(null, rq.logTime('post-header'));
  });
  ...
  server.use(function(rq, rs, n) {
    return n(null, rq.logTime('post-bodyParser'));
  });
