...
(function() {
  ...
  module.exports = function(job, done) {
    var account, accountID, fns, row, time, _ref1;
    job.progress(0, 3);
    account = null;
    accountID = job.data.account;
    time = new Date(parseInt(job.created_at));
    row = job.data.data;
    if (row._type === 'track' && ((_ref1 = row.action) != null ? _ref1.type : void 0) === 'form') {
      console.log("\n\nFORM");
      console.log(row);
      console.log("\n");
    }
    ...
    return async.series(fns, function(err, results) {
      ...
      */
      ...
      combineMappings = function(info, next) {
        var fact, key, mode, s, set, _ref2, _ref3;
        set = ((function() {
        ...
        if (((_ref2 = fact.data) != null ? _ref2.data : void 0) != null) {
          delete fact.data;
        }
        _ref3 = set.field_modes;
        for (key in _ref3) {
          mode = _ref3[key];
          if (mode === 'delete') {
