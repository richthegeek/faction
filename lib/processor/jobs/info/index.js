...
(function() {
  var Cache, addShim, async, evaluate, markForeignFacts, mergeFacts, moment, parseObject, _ref;
  ...
  module.exports = function(job, done) {
    var account, accountID, fns, row, time, _ref1, _ref2;
    job.progress(0, 3);
    account = null;
    accountID = job.data.account;
    time = new Date(parseInt(job.created_at));
    row = job.data.data;
    console.log(row._type, (_ref1 = row.action) != null ? _ref1.type : void 0);
    if (row._type === 'track' && ((_ref2 = row.action) != null ? _ref2.type : void 0) === 'form') {
      console.log("\n\nFORM");
      console.log(row);
      console.log("\n");
    }
      ...
      if (account.settings == null) {
        account.settings = Cache.create('fact-settings-' + accountID, true, function(key, next) {
          return account.database.collection('fact_settings').find().toArray(function(err, settings) {
            var collections, ensureIndex, fk, fks, setting, _i, _len, _ref3;
            if (err || !settings) {
              return next(err, settings);
            }
            collections = {};
            ensureIndex = function(fk, next) {
              var index, val, _name, _ref3;
    ...
    return async.series(fns, function(err, results) {
      ...
      */
      ...
      parseMappings = function(mapping, next) {
        ...
        mapping.update_only = !!((_ref3 = mapping.update_only) != null ? _ref3 : false);
      ...
      combineMappings = function(info, next) {
        var fact, key, mode, s, set, _ref3, _ref4;
        set = ((function() {
        ...
        if (((_ref3 = fact.data) != null ? _ref3.data : void 0) != null) {
          delete fact.data;
        }
        _ref4 = set.field_modes;
        for (key in _ref4) {
          mode = _ref4[key];
          if (mode === 'delete') {
