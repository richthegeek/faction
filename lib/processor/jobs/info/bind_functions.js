...
(function() {
  ...
  module.exports = function(data) {
    var bind_array, bind_iterable, e, _ref1;
    if (((_ref1 = traverse(data)) != null ? _ref1.reduce : void 0) == null) {
      return data;
    }
      ...
      if (((function() {
        ...
        value.betweenDates = function(start, end) {
          return bind_array(this.filter(function(item) {
            var _ref2;
            return (new Date(start) <= (_ref2 = new Date(item._date || new Date())) && _ref2 <= new Date(end));
          }));
        };
      }
    ...
    traverse(data).forEach(function(value) {
      var type, _ref2, _ref3;
      type = Object.prototype.toString.call(value).slice(8, -1);
      if (((value != null ? value.isURL : void 0) != null) || (((_ref2 = this.parent) != null ? (_ref3 = _ref2.node) != null ? _ref3.isURL : void 0 : void 0) != null)) {
      ...
      traverse(data).forEach(function(value) {
        ...
        if (value.indexOf('/') >= 0) {
          ...
          if (urlObj.hostname) {
            ...
            urlObj.isURL = true;
            return this.update(urlObj, true);
          }
        }
      });
    } catch (_error) {
