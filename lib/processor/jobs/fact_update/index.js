...
(function() {
  ...
  module.exports = function(job, done) {
    var accountID, fns, row, s, store, t, time,
      _this = this;
    store = {};
    ...
    fns.hooks = function(next) {
      return store.account.hooks.get(function(e, r) {
        return next(e, r);
      });
    };
    fns.settings = function(next) {
      return store.account.settings.get(function(e, r) {
        return next(e, r);
      });
    };
    fns.conditions = function(next) {
      return store.account.conditions.get(function(e, r) {
        return next(e, r);
      });
    };
    fns.actions = function(next) {
      return store.account.actions.get(function(e, r) {
        return next(e, r);
      });
    };
    fns.fact = function(next) {
      return new Fact_deferred_Model(store.account, row.fact_type, function() {
        var model;
        model = this;
        return this.load({
          _id: row.fact_id
    ...
    return async.series(fns, function(err, results) {
      ...
      context = {
        ...
        load: function(type, id) {
          ...
          new Fact_deferred_Model(store.account, type, function() {
            return this.load({
              _id: id
            }, function(err, found) {
              if (err || !found) {
