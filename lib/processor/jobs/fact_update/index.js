...
(function() {
  ...
  module.exports = {
    ...
    exec: function(job, done) {
      ...
      row = job.data.data;
      debugMode = accountID === 'e55f10efa848b3d3' && row.fact_id === 'richthegeek@gmail.com';
      debug = function() {
        if (debugMode) {
          ...
          return async.mapSeries(conditions, doConditions, function(err, cols2) {
            ...
            if (columns.length > 0) {
              ...
              fact.table.update({
                ...
                if (fact.data._id === '1') {
                  return console.log('Updated', fact.table.db.databaseName, fact.table.collectionName, arguments);
                }
              });
            }
