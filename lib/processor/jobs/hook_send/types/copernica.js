  ...
  */
  ...
  module.exports = {
    ...
    'exec': function(hook, data, callback) {
      var counts, log, options;
      counts = [];
      log = function() {
        return console.log.apply(console, ["\tCopernica"].concat(Array.prototype.slice.apply(arguments)));
      };
      log("starting exec");
            ...
            return async.map(profile.devices, (function(device, next2) {
              ...
              return async.map(device.sessions, (function(session, next3) {
                ...
                return async.map(session.actions, (function(action, next4) {
                  ...
                  var basket, basket_out, doBasket, doLineItems, doOrder, finishSession, key, max, order, times, val, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
                  ...
                  if (basket = session.basket) {
                    ...
                    order = {
                      ...
                      'total': (_ref1 = (_ref2 = basket.prices) != null ? _ref2.ordertotal : void 0) != null ? _ref1 : 0
                    };
                    basket_out = {
                      'value': (_ref3 = (_ref4 = basket.prices) != null ? _ref4.subtotal : void 0) != null ? _ref3 : 0,
                      'Number_of_items': (_ref5 = basket.line_items) != null ? _ref5.length : void 0,
                      'status': 'live'
                    };
                    max = 0;
                    ...
                    return async.series([
                      doOrder = function(next4) {
                        ...
                        counts[4] = 0;
                        return async.mapSeries((_ref7 = basket.line_items) != null ? _ref7 : [], doLineItem, next4);
                      }
                    ], finishSession);
                  } else {
