  ...
  module.exports = {
    ...
    'exec': function(hook, data, callback) {
      ...
      return async.map(data, (function(profile, next) {
        var addSessions, getCollections, loadCopernica, updateProfile, _ref;
        ...
        if ((_ref = profile._id) === '1' || _ref === '100' || _ref === 'clickheretoemailjohn@gmail.com') {
          return next();
        }
        return async.waterfall([
          loadCopernica = function(next1) {
            ...
            data_fields = {
              'uid': profile._id,
              'LeadScore': profile.score.score || 0
            };
            ...
            return async.map(profile.devices, (function(device, next2) {
              ...
              return async.map(device.sessions, (function(session, next3) {
                ...
                return async.map(session.actions, (function(action, next4) {
                  ...
                  if (action._value.type === 'page' && (_ref1 = action._value.url.slice(-3), __indexOf.call(downloadFileTypes, _ref1) >= 0)) {
                  ...
                  var basket, basket_out, doBasket, doLineItems, doOrder, finishSession, key, max, order, times, val, _i, _len, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
                  log("map on session.actions complete");
                  times = [];
                  _ref1 = session.actions;
                  ...
                  if (basket = session.basket) {
                    ...
                    order = {
                      ...
                      'total': (_ref2 = (_ref3 = basket.price) != null ? _ref3.ordertotal : void 0) != null ? _ref2 : 0
                    };
                    basket_out = {
                      'value': (_ref4 = (_ref5 = basket.price) != null ? _ref5.subtotal : void 0) != null ? _ref4 : 0,
                      'Number_of_items': (_ref6 = (_ref7 = basket.basket) != null ? _ref7.length : void 0) != null ? _ref6 : 0,
                      'status': 'live'
                    };
                    max = 0;
                    if (basket.stage != null) {
                      ...
                      for (key in _ref8) {
                        val = _ref8[key];
                        if (!(Math.max(max, val = new Date(val)) === val)) {
                          continue;
                        }
                        max = val;
