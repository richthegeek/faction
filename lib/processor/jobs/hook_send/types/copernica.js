    ...
    Copernica_Base.prototype.init = function(callback) {
      ...
      async.waterfall([
        createClient = function(next) {
          ...
          var cookie, cookies, outCookies, _i, _len, _ref, _ref1, _ref2;
          if (data === '_trakapo_alreadyGotCookies') {
            ...
            if (((_ref = _this.client.lastResponseObj) != null ? _ref.headers : void 0) == null) {
              console.log('malforomed lastResponseObj', _this.client.lastResponseObj);
            }
            cookies = ((_ref1 = _this.client.lastResponseObj) != null ? (_ref2 = _ref1.headers) != null ? _ref2['set-cookie'] : void 0 : void 0) || [];
            outCookies = [];
