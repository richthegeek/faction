            ...
            return async.map(profile.devices, (function(device, next2) {
              ...
              return async.map(device.sessions, (function(session, next3) {
                ...
                return async.map(session.actions, (function(action, next4) {
                  ...
                  var basket, basket_out, doBasket, doLineItems, doOrder, finishSession, key, max, order, times, val, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
                  ...
                  if (basket = session.basket) {
                    ...
                    order = {
                      ...
                      'total': (_ref1 = (_ref2 = basket.price) != null ? _ref2.ordertotal : void 0) != null ? _ref1 : 0
                    };
                    basket_out = {
                      'value': (_ref3 = (_ref4 = basket.price) != null ? _ref4.subtotal : void 0) != null ? _ref3 : 0,
                      'Number_of_items': (_ref5 = (_ref6 = basket.basket) != null ? _ref6.length : void 0) != null ? _ref5 : 0,
                      'status': 'live'
                    };
                    max = 0;
