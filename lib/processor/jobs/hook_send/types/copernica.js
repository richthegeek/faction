            ...
            return async.map(profile.devices, (function(device, next2) {
              ...
              return async.map(device.sessions, (function(session, next3) {
                ...
                return async.map(session.actions, (function(action, next4) {
                  ...
                  var basket, basket_out, doBasket, doLineItems, doOrder, finishSession, key, max, order, times, val, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
                  ...
                  if (basket = session.basket) {
                    ...
                    return async.series([
                      doOrder = function(next4) {
                        ...
                        counts[4] = 0;
                        return async.mapSeries(basket.line_items, doLineItem, next4);
                      }
                    ], finishSession);
                  } else {
