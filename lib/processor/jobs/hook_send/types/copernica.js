            ...
            return async.map(profile.devices, (function(device, next2) {
              ...
              return async.map(device.sessions, (function(session, next3) {
                ...
                return async.map(session.actions, (function(action, next4) {
                  ...
                  var basket, basket_out, doBasket, doLineItems, doOrder, finishSession, key, max, order, times, val, _i, _len, _ref, _ref1, _ref2, _ref3;
                  ...
                  if (basket = session.basket) {
                    ...
                    order = {
                      ...
                      'total': (_ref1 = basket.prices.ordertotal) != null ? _ref1 : 0
                    };
                    basket_out = {
                      'value': (_ref2 = basket.prices.subtotal) != null ? _ref2 : 0,
