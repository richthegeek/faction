                ...
                return async.map(session.actions || [], (function(action, next4) {
                  ...
                  if (basket = session.basket) {
                    ...
                    order = {
                      ...
                      'total': 100 * (parseFloat((_ref1 = (_ref2 = basket.price) != null ? _ref2.items : void 0) != null ? _ref1 : 0) - parseFloat((_ref3 = (_ref4 = basket.price) != null ? _ref4.specialdiscount : void 0) != null ? _ref3 : 0))
                    };
                    basket_out = {
                      'value': order.total,
